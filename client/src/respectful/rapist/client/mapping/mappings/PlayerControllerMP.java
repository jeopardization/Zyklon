...
public class PlayerControllerMP extends MappedClass implements Mappings {
    ...
    public Object windowClick(Object obj, int windowID, int slotID, int p_78753_3_, int p_78753_4_, Object entityPlayer) {
        try {
            return clazz.getDeclaredMethod("func_78753_a", int.class, int.class, int.class, int.class, EntityPlayer.clazz).invoke(obj, windowID, slotID, p_78753_3_, p_78753_4_, entityPlayer);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return null;
