    ...
    public void transform(ClassNode classNode) {
        ...
        for (MethodNode method : classNode.methods) {
            if (method.name.equals("func_73830_a")) {
                method.instructions.insertBefore(method.instructions.getLast().getPrevious(), new MethodInsnNode(INVOKESTATIC, "respectful/rapist/loader/Main", "onRender", "()V", false));
                break;
            }
        }
    }
